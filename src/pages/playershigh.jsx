...
import { ScorePlayers } from "../assets/data/score";
import Stack from '@mui/material/Stack';
import Carousel from 'react-material-ui-carousel';
import { Item } from "../components/item";


export const PlayerHigh = () => {
    return(
        ...
        <div className="homep">
            ...
            <h1 id="heading1">Most Runs (By Individuals) &#x1f4a5; </h1>
            <Carousel>
            { 
                ScorePlayers.map( (params) => <Item im={params} score={true}/>)
            }
            </Carousel>
        </div>
    </div>
